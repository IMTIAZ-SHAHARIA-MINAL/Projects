...
namespace AIRLINEMANAGEMENT
{
    public partial class MemberForm : Form
    {
        ...
        public MemberForm(string text, LoginForm fl) : this()
        {
        ...
        {
            MemberTicketForm TF = new MemberTicketForm();
            TF.Show();
            this.Hide();
        }
        ...
        {
            ViewFlightMemberForm viewflight = new ViewFlightMemberForm();
            viewflight.Show();
            this.Hide();
        }
        ...
        {
            HelpandSupportForm hp = new HelpandSupportForm();
            hp.Show();
            this.Hide();
        }
    }
